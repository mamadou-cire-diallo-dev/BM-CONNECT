...
import { ArrowRightIcon, PlayIcon, ZapIcon, MapPin, CheckIcon, Star } from 'lucide-react';
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {prestatairesDispo.map((prestataire, i) => {
                        if(prestataire.status ==1) {
                           return <PrestatairesDispos prestataire={prestataire} i={i}> </PrestatairesDispos>
                        }
                        else {
                            return <PrestatairesNonDispos prestataire={prestataire} i={i}> </PrestatairesNonDispos>
                        }
                    })}
                </div>
            </div>

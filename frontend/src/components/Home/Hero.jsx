                ...
                <div className="max-w-6xl mx-auto px-4 min-h-screen max-md:w-screen max-md:overflow-hidden pt-32 md:pt-26 flex items-center justify-center">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                        <div className="text-left">
                            <motion.a href="https://prebuiltui.com/tailwind-templates?ref=pixel-forge" className="inline-flex items-center gap-3 pl-3 pr-4 py-1.5 rounded-full bg-black/10 dark:bg-white/10 mb-6 justify-start"
                            ...
                            >
                                ...
                                <span className="text-xs text-gray-900 dark:text-gray-200/90">
                            ...
                            >
                                We design & build <br />
                                <span className="bg-clip-text text-transparent bg-linear-to-r from-indigo-500 to-indigo-600">
                            ...
                            <motion.div className="flex sm:inline-flex overflow-hidden items-center max-sm:justify-center text-sm dark:text-gray-200 bg-black/10 dark:bg-white/10 rounded"
                                initial={{ y: 60, opacity: 0 }}
                                whileInView={{ y: 0, opacity: 1 }}
                                viewport={{ once: true }}
                                transition={{ type: "spring", stiffness: 250, damping: 70, mass: 1, delay: 0.1 }}
                            >
                                <div className="flex items-center gap-2 p-2 px-3 sm:px-6.5 hover:bg-white/3 transition-colors">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-xs text-cyan-500 dark:text-gray-400">
                        ...
                        >
                            <motion.div className="rounded-3xl overflow-hidden border border-black/5 dark:border-white/6 shadow-2xl bg-linear-to-b from-black/30 dark:from-black/50 to-transparent">
                                <div className="relative aspect-16/10 bg-gray-900">
                                    ...
                                    <div className="absolute right-4 bottom-4">
                                        <button className="inline-flex items-center gap-2 rounded-full px-4 py-2 bg-white/6 backdrop-blur-sm hover:bg-white/10 transition focus:outline-none">
                                            <PlayIcon className="size-4" />
                                            <span className="text-xs text-black">See case study</span>
                                        </button>
                                    </div>
                                </div>
                            </motion.div>
                            ...
                            <div className="mt-4 flex gap-3 items-center justify-start">
                                {galleryStripImages.map((src, i) => (
                                    <motion.div
                                        ...
                                        className="w-14 h-10 rounded-lg overflow-hidden border border-black/6 dark:border-white/6"
                                    >
                                        <img
                                            src={src}
                                ...
                                <motion.div className="text-sm text-gray-900 dark:text-gray-400 ml-2 flex items-center gap-2"
                                    initial={{ y: 60, opacity: 0 }}
                                    whileInView={{ y: 0, opacity: 1 }}
                                    viewport={{ once: true }}
                                    transition={{ type: "spring", stiffness: 250, damping: 70, mass: 1, delay: 0.2 }}

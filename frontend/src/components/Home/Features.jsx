            ...
            <div className="max-w-6xl mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {featuresData.map((feature, i) => (
                        ...
                        >
                            <div className="w-12 h-12 rounded-lg text-white bg-indigo-500 dark:bg-violet-900/20 flex items-center justify-center mb-4">
                                {feature.icon}
                            </div>
                            <h3 className="text-lg text-gray-900 dark:text-white font-semibold mb-2">{feature.title}</h3>

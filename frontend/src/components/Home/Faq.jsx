        ...
        <section id="faq" className="py-20 2xl:py-32 text-black">
            <div className="max-w-3xl mx-auto px-4">
                ...
                <Title
                    ...
                    description="Vous trouverez ici toutes les informations nécessaires pour travailler avec notre BM Connect. Pour toute question, n'hésitez pas à nous contacter."
                />

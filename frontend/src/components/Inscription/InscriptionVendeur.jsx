...
export default function InscriptionVendeur() {
  ...
  return (
    <div className=' flex items-center bg-linear-to-br from-[#3f7accff] to-[#0F172A] pt-5 pb-10  md:h-max h-screen w-full'>
        ...
        <div className=''>
          <Link to={'/home'} className={`text-left text-gray-500  `}>
            ...
            taille="3xl"
            />
            <span className='text-gray-700 md:ml-25 my-8 text-xl text-left font-semibold  block ml-15'> Créer votre compte vendeur </span>
            <form onSubmit={handleSubmit(onSubmit)} className='mt-4 flex flex-col px-4 py-2 gap-6 ' >
                ...
                <div className="relative">
                    <input type="hidden" {...register("role")} value="vendeur" />
                </div>
                </div>
